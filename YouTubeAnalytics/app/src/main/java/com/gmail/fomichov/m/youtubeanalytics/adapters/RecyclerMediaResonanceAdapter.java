...
public class RecyclerMediaResonanceAdapter extends RecyclerView.Adapter<RecyclerMediaResonanceAdapter.ViewHolder> {
    private List<ChannelYouTube> listItems;
    private Context context;

    public RecyclerMediaResonanceAdapter(List<ChannelYouTube> listItems, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_media_sort, parent, false); // создаем новый вид
