...
public class MediaResonanceCompare extends Fragment {
    private ChannelsRequest channelsRequestOne;
    private ChannelsRequest channelsRequestTwo;
    private Handler handle;
    private ChannelYouTube tubeOne;
    private ChannelYouTube tubeTwo;
    private int countCommentsOne;
    private int countCommentsTwo;
    private List<String> channelIdArray;
    private List<ChannelYouTube> tubeList;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.frag_mediaresonance_compare, container, false);
    ...
    public static MediaResonanceCompare newInstance() {
        return new MediaResonanceCompare();
    }
}
